...
def solr6():
	# 1. Uploading Solr Config to Zookeepers
        ...
        cmd = '/opt/zookeeper-1/bin/zkCli.sh -zkhost  ss276718-1-ap-northeast-1-aws.searchstax.com:2181 -cmd upconfig -confdir /opt/scripts/testcases/searchstax-client/solr-6/configsets/basic_configs/conf/ -confname test'
