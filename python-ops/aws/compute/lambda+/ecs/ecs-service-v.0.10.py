    ...
    try:
        ...
        if action == "create":
            ...
            if cluster is not None:
                ...
                from defaults import get_default_task
...
def main():
    ...
    parser.add_argument('-a', dest='command', help='Command')
    ...
    action.add_argument('-tid', dest='taskid', help='Stop task')
